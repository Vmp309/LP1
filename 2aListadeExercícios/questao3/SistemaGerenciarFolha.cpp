...
double SistemaGerenciarFolha::consultaSalarioFuncionario(){
    for(int i = 0; i < assalariados.size(); i++){
        std::cout << "Salario do salario do funcionario assalariado " << i + 1 << ": "  << assalariados[i].calcularSalario()
        << std::endl;
    }

    for(int i = 0; i < horistas.size(); i++){
        std::cout << "Salario do salario do funcionario horista " << i + 1 << ": " << horistas[i].calcularSalario()
        << std::endl;
    }

    for(int i = 0; i < comissionados.size(); i++){
        std::cout << "Salario do salario do funcionario comissionado " << i + 1 << ": "  << assalariados[i].calcularSalario()
        << std::endl;
    }
}
